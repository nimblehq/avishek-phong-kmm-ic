...
enum Constant {
    ...
    static let userName = "phong.d@nimblehq.co"
    ...
    static let stagingBundleId = "co.nimblehq.phong.kmmswiftuiic.staging"
    static let productionBundleId = "co.nimblehq.phong.kmmswiftuiic"
    static let projectName = "PhongKMMIC"
